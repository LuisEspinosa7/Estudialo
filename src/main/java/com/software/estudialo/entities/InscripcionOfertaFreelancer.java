...
/**
 * The Class InscripcionOfertaFreelancer.
 *
 * @author LUIS
 */
public class InscripcionOfertaFreelancer {
	...
	/**
	 * Instantiates a new inscripcion oferta freelancer.
	 */
	public InscripcionOfertaFreelancer() {
		super();
	}
	 ...
	 */
	public InscripcionOfertaFreelancer(int id, Oferta oferta, Estudiante estudiante, boolean confirmacion,
